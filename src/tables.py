...
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'SEAT0')]      = (0,  100)
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'SEAT1')]      = (1,  100)
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'SEAT2')]      = (2,  100)
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'CALL')]       = (3,  1)
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'CHECK')]      = (4,  1)
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'RAISE')]      = (5,  1)
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'BET')]        = (6,  1)
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'BETMIN')]     = (7,  1)
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'BETMID')]     = (8,  1)
FEATURE_TUPLE_TO_ID_MAP[('PREFLOP', 'BETMAX')]     = (9,  1)
...
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'RAISE')]         = (15, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'BET')]           = (16, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'BETMIN')]        = (17, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'BETMID')]        = (18, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'BETMAX')]        = (19, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'STACKMIN')]      = (20, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'STACKMID')]      = (21, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'STACKMAX')]      = (22, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'FLUSH')]         = (23, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'FLUSHDRAW')]     = (24, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'STRAIGHT')]      = (25, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'STRAIGHTDRAW')]  = (26, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'ACES')]          = (27, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'KINGS')]         = (28, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'QUEENS')]        = (29, 2)
FEATURE_TUPLE_TO_ID_MAP[('FLOP', 'PAIRS')]         = (30, 2)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'CALL')]          = (31, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'CHECK')]         = (32, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'RAISE')]         = (33, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'BET')]           = (34, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'BETMIN')]        = (35, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'BETMID')]        = (36, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'BETMAX')]        = (37, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'STACKMIN')]      = (38, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'STACKMID')]      = (39, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'STACKMAX')]      = (40, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'FLUSH')]         = (41, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'FLUSHDRAW')]     = (42, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'STRAIGHT')]      = (43, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'STRAIGHTDRAW')]  = (44, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'ACES')]          = (45, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'KINGS')]         = (46, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'QUEENS')]        = (47, 3)
FEATURE_TUPLE_TO_ID_MAP[('TURN', 'PAIRS')]         = (48, 3)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'CALL')]         = (49, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'CHECK')]        = (50, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'RAISE')]        = (51, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'BET')]          = (52, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'BETMIN')]       = (53, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'BETMID')]       = (54, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'BETMAX')]       = (55, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'STACKMIN')]     = (56, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'STACKMID')]     = (57, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'STACKMAX')]     = (58, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'FLUSH')]        = (59, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'FLUSHDRAW')]    = (60, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'STRAIGHT')]     = (61, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'STRAIGHTDRAW')] = (62, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'ACES')]         = (63, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'KINGS')]        = (64, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'QUEENS')]       = (65, 4)
FEATURE_TUPLE_TO_ID_MAP[('RIVER', 'PAIRS')]        = (66, 4)
